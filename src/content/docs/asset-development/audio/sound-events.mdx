---
title: "Sound Events"
description: "Create sound events that control volume, pitch randomization, attenuation, and audio layering for in-game sounds."
---
...
```json title="SFX_Candle_Loop.json"
{
  "Layers": [
    {
