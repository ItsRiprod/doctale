...
`getBlockStateRegistry()` was removed. Register block components via `getChunkStoreRegistry().registerComponent(...)` instead. See [Block Components](/plugin-development/blocks/block-states/) for migration details.
</Aside>
